...
var CollectonExportForm = require('./CollectonExportForm.react');

var CollectionControlls = React.createClass({
    ...
    render: function() {
        ...
        return (
            <div>
                ...
                <CollectonExportForm htmlMarkup={this.props.htmlMarkup} />
            </div>
        )
    }
})

module.exports = CollectionControlls